...
public interface AuthorRepository extends JpaRepository<Author, Long> {
    ...
    @Query(value = "SELECT a.firstName AS firstName, a.lastName AS lastName, SUM(b.copies) AS allCopies FROM Author a" +
            " JOIN a.books AS b GROUP BY b.author ORDER BY allCopies DESC")
